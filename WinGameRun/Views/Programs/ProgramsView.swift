...
struct ProgramsView: View {
    ...
    var body: some View {
        Form {
            ...
            .animation(.appDefault, value: sortedPrograms)
        ...
        .formStyle(.grouped)
        .animation(.appDefault, value: sortedPrograms)
        .animation(.appDefault, value: bottle.settings.blocklist)
        .animation(.appDefault, value: searchText)
        .animation(.appDefault, value: areProgramsExpanded)
        .animation(.appDefault, value: isBlocklistExpanded)
