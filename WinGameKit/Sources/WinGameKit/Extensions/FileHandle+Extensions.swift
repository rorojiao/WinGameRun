...
extension FileHandle {
    ...
    func writeApplicationInfo() {
        ...
        header += "WinGameRun Version: \(Bundle.main.infoDictionary?["CFBundleShortVersionString"] ?? "")\n"
    ...
    func writeInfo(for bottle: Bottle) {
        ...
        if let version = WineInstaller.wineVersion() {
            header += "Wine Version: \(version.major).\(version.minor).\(version.patch)\n"
        }
